...
// MockHwc is a mock of Hwc interface
type MockHwc struct {
	ctrl     *gomock.Controller
	recorder *MockHwcMockRecorder
}

// MockHwcMockRecorder is the mock recorder for MockHwc
type MockHwcMockRecorder struct {
	mock *MockHwc
}

// NewMockHwc creates a new mock instance
func NewMockHwc(ctrl *gomock.Controller) *MockHwc {
	mock := &MockHwc{ctrl: ctrl}
	mock.recorder = &MockHwcMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use
func (m *MockHwc) EXPECT() *MockHwcMockRecorder {
	return m.recorder
}

// CheckWebConfig mocks base method
func (m *MockHwc) CheckWebConfig(buildDir string) error {
	ret := m.ctrl.Call(m, "CheckWebConfig", buildDir)
	ret0, _ := ret[0].(error)
	return ret0
}

// CheckWebConfig indicates an expected call of CheckWebConfig
func (mr *MockHwcMockRecorder) CheckWebConfig(buildDir interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CheckWebConfig", reflect.TypeOf((*MockHwc)(nil).CheckWebConfig), buildDir)
}

// InstallAppHwc mocks base method
func (m *MockHwc) InstallAppHwc() error {
	ret := m.ctrl.Call(m, "InstallAppHwc")
	ret0, _ := ret[0].(error)
	return ret0
}

// InstallAppHwc indicates an expected call of InstallAppHwc
func (mr *MockHwcMockRecorder) InstallAppHwc() *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "InstallAppHwc", reflect.TypeOf((*MockHwc)(nil).InstallAppHwc))
}
